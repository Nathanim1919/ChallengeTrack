...
const ChallengeCard: React.FC<ChallengeCardProps> = ({challenge}) => {
    return (
        <div
            className="max-w-[300px] py-3 h-[400px] bg-sky-500 grid grid-rows-1 justify-between rounded-2xl shadow-lg hover:shadow-md cursor-pointer hover:bg-blue-500">
                ...
                <div className={"flex flex-col items-center justify-center"}>
                    <h3 className={"font-bold text-2xl text-center"}>{challenge.title}</h3>
                        <div className={"flex items-center p-3 gap-2"}>
                            <div className={"h-[30px] w-[30px] bg-sky-400 rounded-full"}></div>
                            <p>Nathan Tadele</p>
                        </div>
                ...
                <div className={"flex relative px-3 justify-between items-center"}>
                    <div className={"relative flex justify-between items-center"}>
                        <div className={'relative flex items-center justify-center'}>
                            ...
                            <div
                                className={'w-[30px] right-5 h-[30px] border-2 border-white relative bg-blue-500 rounded-full'}></div>
                            <div
                                className={'w-[30px] right-10 h-[30px] border-2 border-white relative bg-blue-500 rounded-full'}></div>
                        </div>
                        <h3 className={"-ml-10"}>200+</h3>
                    </div>
                    <button

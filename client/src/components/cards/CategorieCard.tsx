...
const CategorieCard: React.FC<CategorieCardProps> = ({ Categorie }) => {
  ...
  return (
    <div className="relative inset-0 flex justify-center group">
      ...
      <div className={`relative w-full before:absolute before:w-[50%] before:rounded-tl-full before:h-full before:z-0 before:bg-gray-200 before:bottom-0 before:right-0 h-[100%] z-40 shadow-md p-3 border border-gray-300 flex flex-col justify-between bg-white cursor-pointer`}>
        <div>

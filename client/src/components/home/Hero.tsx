...
const Hero: React.FC = () => {
    return (
        <section className="h-[calc(100vh-4rem)] hero overflow-hidden grid justify-center">
            <div className="hero-content overflow-hidden">
                <div className={'flex flex-col items-center gap-2 pt-10'}>
                    <h1 className="hero-title text-5xl md:text-7xl font-bold text-center"> Level Up Your Challenges<br/>and
                        Achievements </h1>

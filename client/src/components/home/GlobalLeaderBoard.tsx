...
const GlobalLeaderBoard=  () => {
    return (
        <div className={'grid grid-cols-1 md:grid-cols-[.2fr_.8fr] justify-center my-10 mx-auto bg-gray-900 pt-10 md:pt-32 overflow-hidden relative'}>
            ...
            <div className={'grid grid-cols-3 m-auto gap-1 mt-24  md:mt-0'}>
                <div className={'flex flex-col items-center'}>
                    ...
                    <div className={'image w-[80px] h-[80px] md:w-[150px] md:h-[150px] border-8 border-white bg-sky-400 rounded-full'}></div>
                ...
                <div className={'flex flex-col items-center relative -top-24 md:-top-32'}>
                    ...
                    <div className={'image w-[100px] h-[100px] md:w-[230px] md:h-[230px] border-8 border-white bg-sky-400 rounded-full'}></div>
                    <div className={'flex flex-col justify-center items-center mt-1'}>
                ...
                <div className={'flex flex-col items-center'}>
                    ...
                    <div className={'image w-[80px] h-[80px] md:w-[170px] border-8 border-white md:h-[170px] bg-sky-400 rounded-full'}></div>
                    <div className={'flex flex-col justify-center items-center mt-1'}>

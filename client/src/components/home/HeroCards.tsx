...
const HeroCard: React.FC<HeroCardProps> = ({ title, bgColor, customClasses, textStyle }) => (
  <div
    ...
    before:absolute before:w-full before:h-full before:${bgColor} before:animate-slowPin
    `}
  >
    <div className={`relative w-full h-full bg-white/10 backdrop-blur-3xl
    `}>
      <div className="flex flex-col items-center relative w-full
      before:absolute before:w-full before:h-full p-[1px] before:animate-spin overflow-hidden
      ">

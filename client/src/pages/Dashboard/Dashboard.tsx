...
const Dashboard: React.FC = () => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-[_.75fr_.25fr] gap-2 m-2 h-[100%] overflow-hidden">
            <div className=" grid grid-rows-[.2fr_.6fr_.1fr_.1fr] gap-2 h-[80%] overflow-y-auto">
                <div className="grid grid-cols-[_.6fr_.4fr] bg-gradient-to-tr from-sky-200 text-white p-2 rounded-lg to-blue-900">
                    <Overview />

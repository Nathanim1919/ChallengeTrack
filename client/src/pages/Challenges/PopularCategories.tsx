  ...
  return (
    <div className="popular-categories grid gap-5 w-[95%] mx-auto">
      <div className="flex items-center justify-between">
        ...
        <button className="bg-gray-200 border border-gray-300 text-black px-2 py-1 cursor-pointer">
          See More
        </button>
      </div>
      <div className="categories grid grid-cols-4 gap-2">
        {categories.slice(0, 4).map((category, index) => (
          <div
            key={index}
            className="category grid cursor-pointer hover:bg-white gap-2 bg-gray-100 border border-gray-300 p-4 place-items-center"
          >
            <div className="">
            ...
            <div className="flex flex-col justify-center items-center gap-1">
              ...
              <p className="text-gray-800 m-0">{category.description}</p>
            </div>
          </div>
        ))}
      </div>

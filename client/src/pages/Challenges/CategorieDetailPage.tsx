...
const CategoryDetailPage: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-[_.3fr_.4fr_.3fr] bg-gray-200">
      ...
      <div className="grid grid-rows-2 h-[100vh] overflow-hidden">
        <div className="bg-gray-200">
          <div className="flex justify-between items-center p-3 bg-white">
            <h1 className="font-bold">Trending Challenges</h1>
            <IoSearch />
          </div>
          <div className="challenges p-2">
            <div className="challenge group border-2 cursor-pointer border-white my-1 mx-auto bg-white grid grid-cols-[_.6fr_.4fr]">
              <div className="p-1">
              ...
              <div className="grid grid-cols-[_.8fr_.2fr] transition-all duration-200 relative overflow-hidden">
                <div className="flex flex-col justify-center">
                  ...
                  <p className="text-[13px] text-gray-600">Pending</p>
                </div>
        ...
        <div className="bg-gray-200">
          <div>
            <h2 className="font-bold p-2 bg-white">Latest challenges</h2>
          </div>
          <div className="p-2">
          <div className="challenge group border-2 cursor-pointer border-white my-1 mx-auto bg-white grid grid-cols-[_.6fr_.4fr]">
              <div className="p-1">
      ...
      <div>
        <h1 className="font-bold text p-3 border-b border-gray-200 bg-white">
          Other Categories
        </h1>
        <div className="flex flex-wrap gap-2 bg-gray-200 p-3">
          {
            // Other categories
